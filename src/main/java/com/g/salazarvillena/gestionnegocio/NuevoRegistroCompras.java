 ...
 */
public class NuevoRegistroCompras extends javax.swing.JFrame {

    /**
     * Creates new form NuevoRegistroCompras
     */
    public NuevoRegistroCompras() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nuevas compras");
        ...
        jLabel5.setText("Precio de compra (unitario):");

        jLabel6.setText("% de ganancia:");
        ...
        jButton3.setText("Guardar en Inventario");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoRegistroCompras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NuevoRegistroCompras().setVisible(true);
            }
        });
    }
